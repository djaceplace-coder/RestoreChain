    ...
    <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden bg-transparent">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          {/* Trust badges */}
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8 mb-8 text-sm font-medium text-gray-300">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <span className="text-sm text-gray-300 mt-2 sm:mt-0">Free initial consultation</span>
          </div>
        </div>
        ...
        <div className="mt-16 md:mt-24 relative max-w-5xl mx-auto">
          ...
          <div className="bg-white/10 backdrop-blur-xl border-white/10 rounded-2xl md:rounded-[2.5rem] p-4 md:p-8 shadow-2xl border border-white/10 overflow-hidden relative">
            {/* Window controls */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="col-span-1 md:col-span-2 bg-white/5 border-white/5 rounded-xl p-6 border border-white/10">
                <div className="flex justify-between items-center mb-6">
                  <div>
                    <p className="text-sm text-gray-300 font-medium">Portfolio Balance</p>
              ...
              <div className="col-span-1 flex flex-col gap-6">
                <div className="bg-brand-dark text-white rounded-xl p-6 relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    <button className="w-full bg-white/10 backdrop-blur-xl border-white/10 text-white py-2.5 rounded-lg text-sm font-semibold hover:bg-gray-100 transition-colors">
                      View Tax Report
                    </button>
                  </div>
                </div>
                
                <div className="bg-white/5 border-white/5 rounded-xl p-6 border border-white/10 flex-1">
                    ...
                    {[
                      ...
                      <div key={i} className="flex justify-between items-center text-sm">
                        ...
                        <div className="text-right">
                          ...
                          <p className="text-gray-400 text-xs">{tx.fiat}</p>
                        </div>
                      </div>
                    ))}
                  </div>
        ...
        <div className="mt-20 pt-10 border-t border-white/10">
          <p className="text-center text-sm font-medium text-gray-300 mb-8 uppercase tracking-wider">Trusted by & Integrated with</p>
